...
<?php
    ...
    if ($_SESSION['privilege']=="admin"||$_SESSION['privilege']=="StaffEncoder"){
        ...
        echo '<div class="menu">';	
        echo '<a href="inquest.php" style="border-bottom: 0.1px solid #607d8b;;font-weight:bold;color:#607d8b;background-color:#e6faff;box-shadow:2px 2px 8px -4px  black"><img src="Images/inquest_investigation_icon_t.png">INQUEST</a>';
...
<div class="w3-container w3-white w3-card" style="margin: 0px 10px 0px 50px;padding:0px; height:100%;">
    ...
    <div class="w3-container w3-blue-grey w3-text-white" align="center" style="border-bottom:1px solid lightgrey">
        <a href="inquest.php" class="w3-btn w3-white w3-border w3-border-cyan w3-hover-light-grey" style="float:left;margin-top:6px;">BACK</a>
        <h4 style="font-weight:bold;">ADD INQUEST</h4>
    </div>
...
if(isset($_POST['addinquest'])){
        ...
        $sql = "SELECT npsdocketnumber FROM inquest_table";
        ...
        VALUES ('$datefile', '$npsdocketnumber', '', '$complainant', '$respondent', '$violation', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '')";
              ...
              if(mysqli_query($con, $sql)){
                     ...
                     echo '<script language="javascript">';
                                    echo 'alert("Record For Inquest Successfully Added")';
                                     echo '</script>';
...
?>
    ...
    <div >   
                ...
                <form action="addinquest.php" method="POST">
                <table align="center">  
                <tr>                                                                
                ...
                <div class=btn>
                        ...
                        <input class="w3-btn w3-light-blue w3-border w3-border-blue w3-hover-cyan" align="left" type="submit" name="addinquest" value="ADD INQUEST" onclick="message">
                        </div>
